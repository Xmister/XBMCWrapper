...
public class Dfs {
    ...
    public HashMap<String, Serializable> getTrustedDomains(NtlmPasswordAuthentication auth) throws SmbAuthException {
        ...
        try {
            ...
            if (dr != null) {
                ...
                do {
                    ...
                    entry.map.put(domain, new HashMap<Object, Object>());
                    dr = dr.next;
                } while (dr != start);
    ...
    {
        HashMap<String, Serializable> domains = getTrustedDomains(auth);
        if (domains == null)
            return false;
    ...
    public synchronized DfsReferral resolve(String domain,
        ...
        if (domains != null) {
			...
			HashMap<String, CacheEntry> roots = (HashMap<String, CacheEntry>)domains.get(domain);
            if (roots != null) {
        ...
        if (dr == null && path != null) {
            ...
            Iterator<String> iter = referrals.map.keySet().iterator();
            while (iter.hasNext()) {

...
public class SID extends rpc.sid_t {
    ...
    static Map<SID, SID> sid_cache = new HashMap<SID, SID>();
...
synchronized (sid_cache) {
     ...
     */
    static Map<SID, ArrayList<SID>> getLocalGroupsMap(String authorityServerName,
                    NtlmPasswordAuthentication auth,
                    int flags) throws IOException {
...
synchronized (sid_cache) {
        try {
            ...
            Map<SID, ArrayList<SID>> map = new HashMap<SID, ArrayList<SID>>();

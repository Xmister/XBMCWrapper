 ...
 */
    ...
    void doEnum(ArrayList<Object> list,
                    boolean files,
                    String wildcard,
    ...
    void doNetServerEnum(ArrayList<Object> list,
                boolean files,
                String wildcard,
                int searchAttributes,
                SmbFilenameFilter fnf,
    ...
    void doFindFirstNext( ArrayList<Object> list,
                boolean files,
                String wildcard,
                int searchAttributes,
                SmbFilenameFilter fnf,
 ...
 * MainGUI to <i>Computer Management</i>
